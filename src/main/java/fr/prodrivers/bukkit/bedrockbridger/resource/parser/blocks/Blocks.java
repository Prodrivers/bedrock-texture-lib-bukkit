package fr.prodrivers.bukkit.bedrockbridger.resource.parser.blocks;
...
import fr.prodrivers.bukkit.bedrockbridger.resource.texture.TerrainTexture;
...
public class Blocks {
	...
	public static Blocks getParser(File filePath, Atlas atlas) throws IOException {
		...
		if(formatVersion.length == 3 && formatVersion[0] == 1 && formatVersion[1] == 1) {
			return new fr.prodrivers.bukkit.bedrockbridger.resource.parser.blocks.format.v1_1_0.Blocks(filePath, atlas);
		}
